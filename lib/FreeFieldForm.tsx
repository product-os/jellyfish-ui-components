...
export default class FreeFieldForm extends React.Component<any, any> {
	dataTypes: any[];
	...
	setFieldTitle(event: any) {
		this.setState({
			key: event.currentTarget.value,
		});
	}

	setFieldType(field: any) {
		this.setState({
		...
		return (
			<Box>
				...
				<Flex
					...
					flexWrap="wrap"
				>
					<Txt mr={2} minWidth={100}>
						Add a new field
					</Txt>

					<FieldInputBox mr={2} my={1}>
						<Input
